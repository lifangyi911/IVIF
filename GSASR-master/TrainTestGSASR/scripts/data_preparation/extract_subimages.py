...
def main(args):
    ...
    # HR images
    for dataset_path in args.gt_path:
        opt['input_folder'] = dataset_path
        opt['save_folder'] = os.path.join(os.path.dirname(dataset_path), f"{os.path.basename(dataset_path)}_subimages{args.crop_size}")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--gt_path", type = list, default=['/home/notebook/data/group/chendu/dataset/DIV2K/trainHR_multiscaleHR_shortest512_new',
                                                           '/home/notebook/data/group/chendu/dataset/Flickr2K/trainHR_multiscaleHR_shortest512_new'])
